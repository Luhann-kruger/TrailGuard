...
TrailGuard is a Windows desktop application that helps national parks manage hiking trails and permits. It also helps park staff keep track of hikers, emergency contacts, and incidents that happen during hikes.

## Features

### Admin Features

* View trails in different parks
* Open or close a trail
* Edit trail information, including:
